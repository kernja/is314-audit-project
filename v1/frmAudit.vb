Public Class frmAudit
    ...
    Private _audit As IS314_Proj1_Kernja.clsAuditor
    'holds the information of the selected Category so the whole form has access to it.
    Private _selectedCategory As IS314_Proj1_Kernja.clsCategory
    Public Sub New(ByRef passedAuditor As IS314_Proj1_Kernja.clsAuditor)
    ...
    Private Sub refreshListBox()
        ...
        Dim _tempCategory As IS314_Proj1_Kernja.clsCategory
    ...
    Private Sub lstCategory_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lstCategory.SelectedIndexChanged
        ...
        Dim _tempCategory As IS314_Proj1_Kernja.clsCategory = _audit.Catagories.getCategory(lstCategory.SelectedItem.ToString)
    ...
    Private Sub UpdateForm()
        ...
        'is passing
        If _selectedCategory.getRating = IS314_Proj1_Kernja.clsAuditor.auditRating.pass Then
        ...
        Dim myRanking As IS314_Proj1_Kernja.clsAuditor.auditRating
        'get the rating.
        ...
        If myRanking = IS314_Proj1_Kernja.clsAuditor.auditRating.fail Then
            Me.txtRating.Text = "FAIL"
            Me.txtRating.BackColor = Color.Red
        ElseIf myRanking = IS314_Proj1_Kernja.clsAuditor.auditRating.pass Then
