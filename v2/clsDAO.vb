Namespace IS314_Proj2_Kernja
    ...
    Public Class clsDAO
        ...
        Public Function createUser(ByVal passedUsername As String, ByVal passedPassword As String, ByVal passedNameFirst As String, ByVal passedNameLast As String, ByVal passedNameMI As String) As DAO_RETURN_MESSAGE
            ...
            Return myReturn
        End Function
        Public Function submitAudit(ByRef passedAuditor As IS314_Assignment1.IS314_Proj2_Kernja.clsAuditor) As DAO_RETURN_MESSAGE
            Dim myReturn As DAO_RETURN_MESSAGE = DAO_RETURN_MESSAGE.DAO_GENERIC_ERROR
        ...
        Public Function getTableNames() As ArrayList
            ...
            Return myReturn
        End Function
        Public Function createAudit(ByVal selectedAudit As Integer, ByRef passedCategoryFactory As IS314_Assignment1.IS314_Proj2_Kernja.clsCategoryFactory) As DAO_RETURN_MESSAGE
            Dim myReturn As DAO_RETURN_MESSAGE = DAO_RETURN_MESSAGE.DAO_SUCCESS
            ...
            Return myReturn
        End Function
        Public Function createCategory(ByVal selectedAudit As Integer, ByRef passedCategoryFactory As IS314_Assignment1.IS314_Proj2_Kernja.clsCategoryFactory) As DAO_RETURN_MESSAGE
            Dim myReturn As DAO_RETURN_MESSAGE = DAO_RETURN_MESSAGE.DAO_SUCCESS
        ...
        Private Function getName(ByVal passedID As Integer, ByRef passedFirstName As String, ByRef passedLastName As String, ByRef passedMiddleName As String) As DAO_RETURN_MESSAGE
            ...
            Return myReturn
        End Function
        Public Function getTable(ByVal passedName As String) As DataTable
            Dim cmd As New MySql.Data.MySqlClient.MySqlCommand
            Dim da As New MySql.Data.MySqlClient.MySqlDataAdapter
            Dim myReturn As New DataTable
