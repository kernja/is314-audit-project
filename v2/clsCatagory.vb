Namespace IS314_Proj2_Kernja
    ...
    Public Class clsCategory
        ...
        'id is for the PK in the DB of what category is which.
        ...
        Public Sub New(ByVal passedIndex As Integer, ByVal passedName As String, ByVal passedMin As Integer, ByVal passedMax As Integer, ByVal passedPassing As Integer, ByVal passedValue As Integer)
            Name = passedName
            Min = passedMin
            Max = passedMax
