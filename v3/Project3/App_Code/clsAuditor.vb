...
Public Class clsAuditor
    ...
    Public Function verifyPassword(ByVal passedUsername As String, ByVal passedPassword As String) As clsDAO.DAO_RETURN_MESSAGE
        ...
        Return myreturn
    End Function
    Public Function LoadCategories(ByVal passedType As Integer) As clsDAO.DAO_RETURN_MESSAGE
        ...
        Dim myReturn As clsDAO.DAO_RETURN_MESSAGE = myDAO.createAudit(1, _CategoryFactory)
        Return myReturn
    End Function
